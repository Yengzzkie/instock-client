    ...
    <>
      <div className="table__container">
        <div className="table__nav">
          ...
          <button className="btn-main edit-btn">+ Add New Warehouse</button>
        </div>
              ...
              <tr key={index}>
                ...
                <td data-label="Action">
                  <Delete
                    onClick={() =>
                      callModalHandler({
                        header: `Delete ${row.item} warehouse item`,
                        body: `Please confirm that you'd like to delete ${row.item} from the warehouse list. You won't be able to undo this action.`,
                      })
                    }
